...
import 'package:healtho/screen/home/top_tab_view/trainer/trainer_profile_screen.dart';
import 'package:healtho/screen/home/top_tab_view/trainer/trainer_row.dart';
      ...
      body: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return TrainerRow(
            obj: listArr[index],
            onPressed: () {
              context.push(const TrainerProfileScreen(isTrainer: false));
            },
          );
        },
