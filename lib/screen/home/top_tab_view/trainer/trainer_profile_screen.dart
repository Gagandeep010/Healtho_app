...
import 'package:healtho/common_widget/title_subtitle_button.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Container(width: 2, height: 45, color: TColor.board),
                Expanded(
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.center,
          ...
          Padding(
            ...
            child: Divider(color: TColor.board, height: 1),
          ),
          TitleSubtitleButton(
